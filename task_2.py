...
# Программа может вычислять площади трех фигур: круга, прямоугольника и треугольника. Для вычисления каждой из них необходима отдельная функция. Пусть каждая из этих функций возвращает полученную площадь, округленную до двух знаков после запятой, а принимает параметры, необходимые для ее вычисления.
